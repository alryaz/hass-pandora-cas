...
from homeassistant.components.lock import LockEntity, DOMAIN as PLATFORM_DOMAIN, ENTITY_ID_FORMAT
...
LOCK_TYPES = {
    'central_lock': {
        ...
        ATTR_ICON: ("mdi:lock-open", "mdi:lock"), ATTR_DEVICE_CLASS: DEVICE_CLASS_LOCK,
        ATTR_ATTRIBUTE: "status", ATTR_FLAG: BitStatus.LOCKED,
...
async_setup_entry = partial(async_platform_setup_entry, PLATFORM_DOMAIN, PandoraCASLock, logger=_LOGGER)
