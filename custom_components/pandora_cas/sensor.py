...
ENTITY_TYPES = [
    ...
    PandoraCASSensorEntityDescription(
        ...
        name="Engine Hours",
        icon="mdi:fan-clock",
        attribute=CurrentState.engine_hours,
    ...
    PandoraCASSensorEntityDescription(
        ...
        name="CAN Engine Hours",
        icon="mdi:fan-clock",
        attribute=CurrentState.can_engine_hours,
        device_class=SensorDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.HOURS,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
    ...
    PandoraCASSensorEntityDescription(
        ...
        attribute=CurrentState.heater_temperature,
        entity_registry_enabled_default=False,
        icon="mdi:thermometer",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
    ...
    PandoraCASSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        attribute=CurrentState.heater_voltage,
        suggested_display_precision=1,
    ),
    PandoraCASSensorEntityDescription(
    ...
    PandoraCASSensorEntityDescription(
        ...
        icon="mdi:wrench-clock",
        attribute=CurrentState.can_days_to_maintenance,
        device_class=SensorDeviceClass.DURATION,
